...
package org.wso2.carbon.dss.syntax.test;
...
public class ReturnRequestStatusTest extends DSSIntegrationTest {
    ...
    public void initialize() throws Exception {
        ...
        serviceEndPoint = dssServer.getServiceUrl() + "/" + serviceName;
    }
    ...
    public void testServiceDeployment() throws RemoteException {
        ...
        assertTrue(dssTest.isServiceDeployed(dssServer.getBackEndUrl(), dssServer.getSessionCookie(),
                                             serviceName));
    }
