...
public class BatchRequestTestCase extends DSSIntegrationTest {
    ...
    private void deleteEmployee(int employeeNo) throws AxisFault {
        ...
        new AxisServiceClient().sendRobust(payload, getServiceUrl(serviceName), "deleteEmployee");
    ...
    private String employeeExists(String empId) throws AxisFault {
        ...
        OMElement response = new AxisServiceClient().sendReceive(payload, getServiceUrl(serviceName), "employeeExists");
        assertNotNull("Response null " + response);
        return response.getFirstElement().getFirstElement().getText();
    }

    private void addEmployee(int employeeNo) throws AxisFault {
        ...
        new AxisServiceClient().sendRobust(payload, getServiceUrl(serviceName), "addEmployee");
    ...
    private void addEmployeeBatchRequest() throws AxisFault {
        ...
        new AxisServiceClient().sendRobust(payload, getServiceUrl(serviceName), "addEmployee_batch_req");
    ...
    private void deleteEmployeeBatchRequest() throws AxisFault {
        ...
        new AxisServiceClient().sendRobust(payload, getServiceUrl(serviceName), "deleteEmployee_batch_req");
