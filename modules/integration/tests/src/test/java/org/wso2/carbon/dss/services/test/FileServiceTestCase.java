...
public class FileServiceTestCase extends DSSIntegrationTest {
    ...
    public void createNewFile() throws AxisFault {
        ...
        new AxisServiceClient().sendRobust(payload, getServiceUrl(serviceName), "_getcreatenewfile");
    ...
    public void checkFileType() throws AxisFault {
        ...
        OMElement result = new AxisServiceClient().sendReceive(payload, getServiceUrl(serviceName), "_getgetgetfiletype");
    ...
    public void checkFileName() throws AxisFault {
        ...
        OMElement result = new AxisServiceClient().sendReceive(payload, getServiceUrl(serviceName), "_getgetfilenames");
        Assert.assertNotNull(result, "Response message null ");
...
//        BASE64Decoder decoder = new BASE64Decoder();
        for (int i = 0; i < 5; i++) {
            ...
            axisClient.sendRobust(payload, getServiceUrl(serviceName), "_postappenddatatofile");
    ...
    public void checkFileSize() throws AxisFault {
        ...
        OMElement result = new AxisServiceClient().sendReceive(payload, getServiceUrl(serviceName), "_getgetfilesize");
    ...
    public void deleteFile() throws AxisFault {
        ...
        new AxisServiceClient().sendRobust(payload, getServiceUrl(serviceName), "_getdeletefile");
        response = checkFileExists();
    ...
    private OMElement getRecord() throws AxisFault {
        ...
        OMElement result = new AxisServiceClient().sendReceive(payload, getServiceUrl(serviceName), "_getgetfilerecords");
        Assert.assertNotNull(result, "Response message null ");
        return result;
    }
    ...
    private OMElement checkFileExists() throws AxisFault {
        ...
        OMElement result = new AxisServiceClient().sendReceive(payload, getServiceUrl(serviceName), "_getcheckfileexists");
        Assert.assertNotNull(result, "Response message null ");
