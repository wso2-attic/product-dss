...
public class DistributedTransactionTestCase extends DSSIntegrationTest {
    ...
    public void addBankAccountToADatabase() throws AxisFault {
        addBankAccount1test();
        log.info("Added bank account on database1");
    }

    @Test(groups = {"wso2.dss"})
    public void addBankAccountOnOtherDatabase() throws AxisFault {
        addBankAccount2test();
    ...
    public void distributedTransactionTest() throws AxisFault {
        distributedTransactionSuccess();
        log.info("Added transaction on both databases");
    }

    @Test(groups = {"wso2.dss"}, dependsOnMethods = {"addBankAccountToADatabase", "addBankAccountOnOtherDatabase"})
    public void distributedTransactionFailTest() throws AxisFault {
    ...
    private void addBankAccount1test() throws AxisFault {
        ...
        options = new Options();
        options.setTo(new EndpointReference(getServiceUrl(serviceName)));
    ...
    private void addBankAccount2test() throws AxisFault {
        ServiceClient sender;
        Options options;
        OMElement response;
    ...
    private void distributedTransactionSuccess() throws AxisFault {
        ServiceClient sender;
        Options options;
    ...
    private void distributedTransactionFail() throws AxisFault {
        ServiceClient sender;
        Options options;
    ...
    private DataHandler getArtifactWithDTP(String serviceFile)
        ...
        String dtpDriver;
        dataSource1 = new SqlDataSourceUtil(dssServer.getSessionCookie(), dssServer.getBackEndUrl(), FrameworkFactory.getFrameworkProperties(ProductConstant.DSS_SERVER_NAME), userId);
        dataSource2 = new SqlDataSourceUtil(dssServer.getSessionCookie(), dssServer.getBackEndUrl(), FrameworkFactory.getFrameworkProperties(ProductConstant.DSS_SERVER_NAME), userId);
        ...
        try {
            OMElement dbsFile = AXIOMUtil.stringToOM(FileManager.readFile(ProductConstant.SYSTEM_TEST_RESOURCE_LOCATION + "artifacts"
