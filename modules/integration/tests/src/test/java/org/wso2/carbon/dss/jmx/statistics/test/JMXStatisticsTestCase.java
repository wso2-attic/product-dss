...
*under the License.
*/
package org.wso2.carbon.dss.jmx.statistics.test;
...
import org.wso2.carbon.dss.jmx.statistics.test.utils.JMXClient;
...
public class JMXStatisticsTestCase extends DSSIntegrationTest {
    ...
    public void serviceDeployment() throws Exception {
        ...
        jmxClient = new JMXClient(serviceName, dssServer.getProductVariables().getHostName(),
    ...
    public void selectOperation() throws AxisFault {
        ...
        OMElement result = new AxisServiceClient().sendReceive(payload, getServiceUrl(serviceName),
                                                               "getProducts");
