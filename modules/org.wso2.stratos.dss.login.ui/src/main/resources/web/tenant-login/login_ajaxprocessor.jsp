...
<head>
    ...
    <title>WSO2 Stratos Data Service Server</title>
    ...
    <link rel="stylesheet" type="text/css" href="../tenant-login/css/loginpage.css"/>
		...
		<div id="login-content">
					...
					<div class="feature feature-left">
						...
						<p>
							Service Hosting features in Data Service Server enables deployment of data services and other services like Axis2 Services, JAXWS Services.
						</p>
					</div>
					<div class="feature">
				...
				<div id="footer">
					<div class="powered">
						<span>Powered by</span><a target="_blank" href="http://wso2.org/projects/ds"><img src="../tenant-login/images/powered.gif"/></a>
					</div>
