...
public class MultipleServicesGeneratorTestCase extends DSSIntegrationTest {
    ...
    public void initializeTest() throws Exception {
        ...
        dataServiceAdminClient =
                new DataServiceAdminClient(dssServer.getBackEndUrl(), userInfo.getUserName(),
                                           userInfo.getPassword());
        serviceEPR_1 = dssServer.getBackEndUrl() + SERVICE_NAME_1;
        serviceEPR_2 = dssServer.getBackEndUrl() + SERVICE_NAME_2;
    ...
    public void testServiceDeployment() throws RemoteException {
        assertTrue(dssTestCaseUtils.isServiceDeployed(dssServer.getBackEndUrl(),
                                                      dssServer.getSessionCookie(), SERVICE_NAME_1));
        assertTrue(dssTestCaseUtils.isServiceDeployed(dssServer.getBackEndUrl(),
                                                      dssServer.getSessionCookie(), SERVICE_NAME_2));
