...
import org.wso2.carbon.dss.samples.test.GSpreadSampleTestCase;
...
public class SQLDriverGspreadSheetTestCase extends DSSIntegrationTest {
    ...
    private static String serviceName = "GSpreadSQLDriverSample";
    private static String serverEpr;
    private static String inputValue = String.valueOf(System.currentTimeMillis());
    ...
    @Test(groups = "wso2.dss", description = "Drop sheet", dependsOnMethods = "testServiceDeployment")
    ...
    @Test(groups = "wso2.dss", description = "Add new sheet", dependsOnMethods = "testDropTheSheetIfExists")
    ...
    @Test(groups = "wso2.dss", description = "Drop sheet", dependsOnMethods = "testNewSheetPayload")
    public void testDropSheet() throws RemoteException, InterruptedException {
        Thread.sleep(5000);
        new AxisServiceClient().sendRobust(dropSheetSQLPayload(), serverEpr, "dropSheetSQL");
    }

    @Test(groups = "wso2.dss", description = "add customer", dependsOnMethods = "testDropSheet")
    ...
    @Test(groups = "wso2.dss", description = "Update customer", dependsOnMethods = "testAddEmployee")
    ...
    @Test(groups = "wso2.dss", description = "Delete customer", dependsOnMethods = "testUpdateCustomer")
